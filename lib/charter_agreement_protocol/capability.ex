defmodule CharterAgreementProtocol.Capability do
  ...
  @known_answer_message Base.url_decode64!(
                          "Y2hhcnRlci1hZ3JlZW1lbnQtcHJvdG9jb2wgY2FwYWJpbGl0eSBrbm93bi1hbnN3ZXI",
                          padding: false
                        )
  ...
  @known_answers %{
    "Ed25519" => %{
      public_key:
        Base.url_decode64!("GzQZjEZ9YYJWL3R3uwR0owiJSd55-Dl33NgTbuWBewc", padding: false),
      signature:
        Base.url_decode64!(
          "-H0dvAgkit6g5XUHSeemuI_1BQK2ZZaip-cskYhB6Jv2YNBAASg3B57dXW30ezxbH9YVPgWc3TA3qx74TN5UDA",
          padding: false
        )
    },
    "ML-DSA-44" => %{
  ...
  def declared?("ML-DSA-44", public_keys, _curves),
    do: :mldsa44 in declared_public_keys(public_keys)

  def declared?("ML-DSA-65", public_keys, _curves),
    do: :mldsa65 in declared_public_keys(public_keys)

  def declared?("ML-DSA-87", public_keys, _curves),
    do: :mldsa87 in declared_public_keys(public_keys)
