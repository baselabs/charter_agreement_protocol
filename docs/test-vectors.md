...
| Specification digest | `sha-256:B5NOXu15y618o6KgX5Goho4ycWJSDZTbZH41tpZtoWA` | Domain-separated digest over the canonical manifest of the normative spec set (`spec/`); pinned in release metadata |
